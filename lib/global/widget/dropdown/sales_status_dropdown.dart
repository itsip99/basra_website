...
class SalesStatusDropdown extends StatefulWidget {
  ...
  @override
  State<SalesStatusDropdown> createState() => _SalesStatusDropdownState();
}

class _SalesStatusDropdownState extends State<SalesStatusDropdown> {
  String teksDisable = '';
  String value = '';
    ...
    if (!widget.isMobile) {
      return DropdownButtonHideUnderline(
        child: DropdownButton(
          menuWidth: MediaQuery.of(context).size.width * 0.12,
