...
class SipShopDropdown extends StatefulWidget {
  const SipShopDropdown({
  ...
  @override
  State<SipShopDropdown> createState() => _SipShopDropdownState();
}

class _SipShopDropdownState extends State<SipShopDropdown> {
  String teksDisable = '';
  String value = '';
  ...
  Widget build(BuildContext context) {
    ...
    // print('SIP Dropdown provider: ${state.getSipShopList.length}');
        ...
        child: DropdownButton(
          ...
          onChanged: (newValues) async {
            if (value != newValues) {
              ...
              try {
                await state.loadSipLocation(
                  branch: widget.branch,
                  shop: value,
                );
              } catch (e) {
                print('loadSipLocation: $e');
              }
            }
          },
        ),
