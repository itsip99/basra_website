...
class STUbyKategori extends StatefulWidget {
  final Map<String, List<DataSTUBYKategori>> groupedDataSTUpage1;

  STUbyKategori({required this.groupedDataSTUpage1});

  @override
  _SalesPagesState createState() => _SalesPagesState(groupedDataSTUpage1);
}

class _SalesPagesState extends State<STUbyKategori> {
  final Map<String, List<DataSTUBYKategori>> groupedDataSTUpage1;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      child: Column(children: [
          ...
          children: [
            Container(
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  context.goNamed(RoutesConstant.salesDashboardtipeDaily);
                },
                child: Row(
                  children: [
            ...
            Container(
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  context.goNamed(RoutesConstant.salesDashboardtipe);
                },
                child: Row(
                  children: [
        ...
        ...groupedDataSTUpage1['1']!.map((emp2) {
