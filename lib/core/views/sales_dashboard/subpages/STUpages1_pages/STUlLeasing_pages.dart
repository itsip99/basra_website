...
class STUbyLeasing extends StatefulWidget {
  final Map<String, List<DataSTUBYKategori>> groupedDataSTUpage1;

  static final List<DataSTUBYKategori> data = [];

  STUbyLeasing({required this.groupedDataSTUpage1});

  @override
  _SalesPagesState createState() => _SalesPagesState(groupedDataSTUpage1);
}

class _SalesPagesState extends State<STUbyLeasing> {
  final Map<String, List<DataSTUBYKategori>> groupedDataSTUpage1;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      child: Column(children: [
          ...
          children: [
            Container(
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  context.goNamed(RoutesConstant.salesDashboardleasingGroupCC);
                },
                child: Row(
                  children: [
            ...
            Container(
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  context.goNamed(RoutesConstant.salesDashboardleasingArea);
                },
                child: Row(
                  children: [
                    Icon(Icons.area_chart_sharp),
            ...
            Container(
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  context.goNamed(RoutesConstant.salesDashboardleasingDP);
                },
                child: Row(
                  children: [
                    Icon(Icons.payment),
        ...
        ...groupedDataSTUpage1['3']!.map((emp) {
          if (emp.Kategori == "TUNAI" || emp.Kategori == "KREDIT") {
          ...
          return Row(
            children: [
              ...
              Expanded(
                flex: 1,
                child: CellDashboard1(
                    textTitle: emp.LY.toString().length > 3
                        ? CurrencyFormat.convertToIdr(emp.LY, 0).toString()
                        : emp.LY.toString()),
              ),
              Expanded(
                flex: 1,
        ...
        ...groupedDataSTUpage1['3']!.map((emp2) {
          ...
          return Row(
            children: [
              ...
              Expanded(
                ...
                child: CellDashboard3(
                  textTitle:
                      '${ServiceReusable.parseAndHandleNaNPercent((emp2.Qty2 / (kategoriSum['sumQTY2']) * 100))} %',
                ),
              ),
              Expanded(
                flex: 1,
