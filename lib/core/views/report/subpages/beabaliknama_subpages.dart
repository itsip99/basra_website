...
class BeaBalikNamaSubPages extends StatefulWidget {
  String category = "";
  String nama = "";
  String pt = "";

  BeaBalikNamaSubPages({
    Key? key,
  ...
  @override
  State<BeaBalikNamaSubPages> createState() => _BeaBalikNamaSubPagesState();
}

class _BeaBalikNamaSubPagesState extends State<BeaBalikNamaSubPages> {
  ...
  List<ListReport> listBeabaliknama = [];
...
// Periode 1
  ...
  Future<void> fetchReport() async {
    ...
    for (var i = 0; i < ReportPages.listReport.length; i++) {
      if (ReportPages.listReport[i].category == widget.category) {
        listBeabaliknama.add(ReportPages.listReport[i]);
      }
    }
  }
  ...
  void fetchdataAwal() {
    ...
    selectedReport = listBeabaliknama[0].reportName.toString();

    for (var i = 0; i < listBeabaliknama.length; i++) {
      if (listBeabaliknama[i].reportName! == selectedReport) {
        filelist.add(listBeabaliknama[i]);
      }
    }
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: DropdownButtonFormField<String>(
                        ...
                        value: listBeabaliknama.first.reportName,
                        items: listBeabaliknama.map((report) {
                        ...
                        onChanged: (value) {
                          setState(() {
                            ...
                            _BeaBalikNamaSubPagesState.filelist.clear();

                            for (var i = 0; i < listBeabaliknama.length; i++) {
                              if (listBeabaliknama[i].reportName! ==
                                  selectedReport) {
                                _BeaBalikNamaSubPagesState.filelist
                                    .add(listBeabaliknama[i]);
                              }
                            }
