...
class AccountingSubPages extends StatefulWidget {
  String category = "";
  String nama = "";
  String pt = "";
  ...
  @override
  State<AccountingSubPages> createState() => _AccountingSubPagesState();
}

class _AccountingSubPagesState extends State<AccountingSubPages> {
...
// Periode 1
  ...
  Future<void> fetchReport() async {
    ...
    for (var i = 0; i < ReportPages.listReport.length; i++) {
      if (ReportPages.listReport[i].category == widget.category) {
        listAccReport.add(ReportPages.listReport[i]);
      }
    }
  }
  ...
  void fetchdataAwal() {
    ...
    selectedReport = listAccReport[0].reportName.toString();

    for (var i = 0; i < listAccReport.length; i++) {
      if (listAccReport[i].reportName! == selectedReport) {
        filelist.add(listAccReport[i]);
      }
    }
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: DropdownButtonFormField<String>(
                        ...
                        value: listAccReport.first.reportName,
                        items: listAccReport.map((report) {
                        ...
                        onChanged: (value) {
                          setState(() {
                            ...
                            _AccountingSubPagesState.filelist.clear();

                            for (var i = 0; i < listAccReport.length; i++) {
                              if (listAccReport[i].reportName! ==
                                  selectedReport) {
                                _AccountingSubPagesState.filelist
                                    .add(listAccReport[i]);
                              }
                            }
