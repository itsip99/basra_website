...
class LainLainSubpages extends StatefulWidget {
  String category = "";
  String nama = "";
  String pt = "";
  ...
  @override
  State<LainLainSubpages> createState() => _LainLainSubpagesState();
}

class _LainLainSubpagesState extends State<LainLainSubpages> {
...
// Periode 1
  ...
  Future<void> fetchReport() async {
    ...
    for (var i = 0; i < ReportPages.listReport.length; i++) {
      if (ReportPages.listReport[i].category == widget.category) {
        listLain2.add(ReportPages.listReport[i]);
      }
    }
  }
  ...
  void fetchdataAwal() {
    ...
    selectedReport = listLain2[0].reportName.toString();

    for (var i = 0; i < listLain2.length; i++) {
      if (listLain2[i].reportName! == selectedReport) {
        filelist.add(listLain2[i]);
      }
    }
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: DropdownButtonFormField<String>(
                        ...
                        value: listLain2.first.reportName,
                        items: listLain2.map((report) {
                        ...
                        onChanged: (value) {
                          setState(() {
                            ...
                            _LainLainSubpagesState.filelist.clear();

                            for (var i = 0; i < listLain2.length; i++) {
                              if (listLain2[i].reportName! == selectedReport) {
                                _LainLainSubpagesState.filelist
                                    .add(listLain2[i]);
                              }
                            }
