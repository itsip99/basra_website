...
class FakturPajakSubPages extends StatefulWidget {
  String category = "";
  String nama = "";
  String pt = "";
  ...
  @override
  State<FakturPajakSubPages> createState() => _FakturPajakSubPagesState();
}

class _FakturPajakSubPagesState extends State<FakturPajakSubPages> {
...
// Periode 1
  ...
  Future<void> fetchReport() async {
    ...
    for (var i = 0; i < ReportPages.listReport.length; i++) {
      if (ReportPages.listReport[i].category == widget.category) {
        listFaktur.add(ReportPages.listReport[i]);
      }
    }
  }
  ...
  void fetchdataAwal() {
    ...
    selectedReport = listFaktur[0].reportName.toString();

    for (var i = 0; i < listFaktur.length; i++) {
      if (listFaktur[i].reportName! == selectedReport) {
        filelist.add(listFaktur[i]);
      }
    }
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: DropdownButtonFormField<String>(
                        ...
                        value: listFaktur.first.reportName,
                        items: listFaktur.map((report) {
                        ...
                        onChanged: (value) {
                          setState(() {
                            ...
                            _FakturPajakSubPagesState.filelist.clear();

                            for (var i = 0; i < listFaktur.length; i++) {
                              if (listFaktur[i].reportName! == selectedReport) {
                                _FakturPajakSubPagesState.filelist
                                    .add(listFaktur[i]);
                              }
                            }
