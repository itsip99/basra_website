...
class RegistrasiSubPages extends StatefulWidget {
  String category = "";
  String nama = "";
  String pt = "";
  ...
  @override
  State<RegistrasiSubPages> createState() => _RegistrasiSubPagesState();
}

class _RegistrasiSubPagesState extends State<RegistrasiSubPages> {
  ...
  List<ListReport> listRegistrasiReport = [];
...
// Periode 1
  ...
  Future<void> fetchReport() async {
    ...
    for (var i = 0; i < ReportPages.listReport.length; i++) {
      if (ReportPages.listReport[i].category == widget.category) {
        listRegistrasiReport.add(ReportPages.listReport[i]);
      }
    }
  }
  ...
  void fetchdataAwal() {
    ...
    selectedReport = listRegistrasiReport[0].reportName.toString();

    for (var i = 0; i < listRegistrasiReport.length; i++) {
      if (listRegistrasiReport[i].reportName! == selectedReport) {
        filelist.add(listRegistrasiReport[i]);
      }
    }
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: DropdownButtonFormField<String>(
                        ...
                        value: listRegistrasiReport.first.reportName,
                        items: listRegistrasiReport.map((report) {
                        ...
                        onChanged: (value) {
                          setState(() {
                            ...
                            _RegistrasiSubPagesState.filelist.clear();

                            for (var i = 0;
                                i < listRegistrasiReport.length;
                                i++) {
                              if (listRegistrasiReport[i].reportName! ==
                                  selectedReport) {
                                _RegistrasiSubPagesState.filelist
                                    .add(listRegistrasiReport[i]);
                              }
                            }
