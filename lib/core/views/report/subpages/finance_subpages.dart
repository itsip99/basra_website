...
class FinanceSubPages extends StatefulWidget {
  String category = "";
  String nama = "";
  String pt = "";
  ...
  @override
  State<FinanceSubPages> createState() => _FinanceSubPagesState();
}

class _FinanceSubPagesState extends State<FinanceSubPages> {
  ...
  List<ListReport> listFinanceReport = [];
...
// Periode 1
  ...
  Future<void> fetchReport() async {
    ...
    for (var i = 0; i < ReportPages.listReport.length; i++) {
      if (ReportPages.listReport[i].category == widget.category) {
        listFinanceReport.add(ReportPages.listReport[i]);
      }
    }
  }
  ...
  void fetchdataAwal() {
    ...
    selectedReport = listFinanceReport[0].reportName.toString();

    for (var i = 0; i < listFinanceReport.length; i++) {
      if (listFinanceReport[i].reportName! == selectedReport) {
        filelist.add(listFinanceReport[i]);
      }
    }
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: DropdownButtonFormField<String>(
                        ...
                        value: listFinanceReport.first.reportName,
                        items: listFinanceReport.map((report) {
                        ...
                        onChanged: (value) {
                          setState(() {
                            ...
                            _FinanceSubPagesState.filelist.clear();

                            for (var i = 0; i < listFinanceReport.length; i++) {
                              if (listFinanceReport[i].reportName! ==
                                  selectedReport) {
                                _FinanceSubPagesState.filelist
                                    .add(listFinanceReport[i]);
                              }
                            }
