...
class PembelianSubPages extends StatefulWidget {
  String category = "";
  String nama = "";
  String pt = "";
  ...
  @override
  State<PembelianSubPages> createState() => _PembelianPagesState();
}

class _PembelianPagesState extends State<PembelianSubPages> {
...
// Periode 1
  ...
  Future<void> fetchReport() async {
    ...
    for (var i = 0; i < ReportPages.listReport.length; i++) {
      if (ReportPages.listReport[i].category == widget.category) {
        listPembelian.add(ReportPages.listReport[i]);
      }
    }
  }
  ...
  void fetchdataAwal() {
    ...
    selectedReport = listPembelian[0].reportName.toString();

    for (var i = 0; i < listPembelian.length; i++) {
      if (listPembelian[i].reportName! == selectedReport) {
        filelist.add(listPembelian[i]);
      }
    }
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: DropdownButtonFormField<String>(
                        ...
                        value: listPembelian.first.reportName,
                        items: listPembelian.map((report) {
                        ...
                        onChanged: (value) {
                          setState(() {
                            ...
                            _PembelianPagesState.filelist.clear();

                            for (var i = 0; i < listPembelian.length; i++) {
                              if (listPembelian[i].reportName! ==
                                  selectedReport) {
                                _PembelianPagesState.filelist
                                    .add(listPembelian[i]);
                              }
                            }
