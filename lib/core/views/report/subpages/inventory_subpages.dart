...
class InventorySubPages extends StatefulWidget {
  String category = "";
  String nama = "";
  String pt = "";
  ...
  @override
  State<InventorySubPages> createState() => _InventorySubPagesState();
}

class _InventorySubPagesState extends State<InventorySubPages> {
  ...
  List<ListReport> listInventoryReport = [];
...
// Periode 1
  ...
  Future<void> fetchReport() async {
    ...
    for (var i = 0; i < ReportPages.listReport.length; i++) {
      if (ReportPages.listReport[i].category == widget.category) {
        listInventoryReport.add(ReportPages.listReport[i]);
      }
    }
  }
  ...
  void fetchdataAwal() {
    ...
    selectedReport = listInventoryReport[0].reportName.toString();

    for (var i = 0; i < listInventoryReport.length; i++) {
      if (listInventoryReport[i].reportName! == selectedReport) {
        filelist.add(listInventoryReport[i]);
      }
    }
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: DropdownButtonFormField<String>(
                        ...
                        value: listInventoryReport.first.reportName,
                        items: listInventoryReport.map((report) {
                        ...
                        onChanged: (value) {
                          setState(() {
                            ...
                            _InventorySubPagesState.filelist.clear();

                            for (var i = 0;
                                i < listInventoryReport.length;
                                i++) {
                              if (listInventoryReport[i].reportName! ==
                                  selectedReport) {
                                _InventorySubPagesState.filelist
                                    .add(listInventoryReport[i]);
                              }
                            }
