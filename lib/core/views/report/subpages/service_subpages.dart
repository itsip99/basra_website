...
class ServiceSubPages extends StatefulWidget {
  String category = "";
  String nama = "";
  String pt = "";
  ...
  @override
  State<ServiceSubPages> createState() => _ServiceSubPagesState();
}

class _ServiceSubPagesState extends State<ServiceSubPages> {
  ...
  List<ListReport> listServiceReport = [];
...
// Periode 1
  ...
  Future<void> fetchReport() async {
    ...
    for (var i = 0; i < ReportPages.listReport.length; i++) {
      if (ReportPages.listReport[i].category == widget.category) {
        listServiceReport.add(ReportPages.listReport[i]);
      }
    }
  }
  ...
  void fetchdataAwal() {
    ...
    selectedReport = listServiceReport[0].reportName.toString();

    for (var i = 0; i < listServiceReport.length; i++) {
      if (listServiceReport[i].reportName! == selectedReport) {
        filelist.add(listServiceReport[i]);
      }
    }
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: DropdownButtonFormField<String>(
                        ...
                        value: listServiceReport.first.reportName,
                        items: listServiceReport.map((report) {
                        ...
                        onChanged: (value) {
                          setState(() {
                            ...
                            _ServiceSubPagesState.filelist.clear();

                            for (var i = 0; i < listServiceReport.length; i++) {
                              if (listServiceReport[i].reportName! ==
                                  selectedReport) {
                                _ServiceSubPagesState.filelist
                                    .add(listServiceReport[i]);
                              }
                            }
