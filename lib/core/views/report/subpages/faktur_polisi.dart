...
class FakturPolisiSubPages extends StatefulWidget {
  String category = "";
  String nama = "";
  String pt = "";

  FakturPolisiSubPages({
    Key? key,
  ...
  @override
  State<FakturPolisiSubPages> createState() => _FakturPolisiSubPagesState();
}

class _FakturPolisiSubPagesState extends State<FakturPolisiSubPages> {
  ...
  List<ListReport> listFaktorPolisi = [];
...
// Periode 1
  ...
  Future<void> fetchReport() async {
    ...
    for (var i = 0; i < ReportPages.listReport.length; i++) {
      if (ReportPages.listReport[i].category == widget.category) {
        listFaktorPolisi.add(ReportPages.listReport[i]);
      }
    }
  }
  ...
  void fetchdataAwal() {
    ...
    selectedReport = listFaktorPolisi[0].reportName.toString();

    for (var i = 0; i < listFaktorPolisi.length; i++) {
      if (listFaktorPolisi[i].reportName! == selectedReport) {
        filelist.add(listFaktorPolisi[i]);
      }
    }
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: DropdownButtonFormField<String>(
                        ...
                        value: listFaktorPolisi.first.reportName,
                        items: listFaktorPolisi.map((report) {
                        ...
                        onChanged: (value) {
                          setState(() {
                            ...
                            _FakturPolisiSubPagesState.filelist.clear();

                            for (var i = 0; i < listFaktorPolisi.length; i++) {
                              if (listFaktorPolisi[i].reportName! ==
                                  selectedReport) {
                                _FakturPolisiSubPagesState.filelist
                                    .add(listFaktorPolisi[i]);
                              }
                            }
