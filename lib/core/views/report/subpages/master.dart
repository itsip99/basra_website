...
class MasterSubPages extends StatefulWidget {
  String category = "";
  String nama = "";
  String pt = "";
  ...
  @override
  State<MasterSubPages> createState() => _MasterSubPagesState();
}

class _MasterSubPagesState extends State<MasterSubPages> {
...
// Periode 1
  ...
  Future<void> fetchReport() async {
    ...
    for (var i = 0; i < ReportPages.listReport.length; i++) {
      if (ReportPages.listReport[i].category == widget.category) {
        listMaster.add(ReportPages.listReport[i]);
      }
    }
  }
  ...
  void fetchdataAwal() {
    ...
    selectedReport = listMaster[0].reportName.toString();

    for (var i = 0; i < listMaster.length; i++) {
      if (listMaster[i].reportName! == selectedReport) {
        filelist.add(listMaster[i]);
      }
    }
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: DropdownButtonFormField<String>(
                        ...
                        value: listMaster.first.reportName,
                        items: listMaster.map((report) {
                        ...
                        onChanged: (value) {
                          setState(() {
                            ...
                            _MasterSubPagesState.filelist.clear();

                            for (var i = 0; i < listMaster.length; i++) {
                              if (listMaster[i].reportName! == selectedReport) {
                                _MasterSubPagesState.filelist
                                    .add(listMaster[i]);
                              }
                            }
