...
class Dashboard02 extends StatefulWidget {
  const Dashboard02(this.listDashboard, {super.key});
  final List<Dashboard> listDashboard;

  @override
  State<Dashboard02> createState() => _Dashboard02State();
}

class _Dashboard02State extends State<Dashboard02>
    with AutomaticKeepAliveClientMixin<Dashboard02> {
  ...
  void sortGRUP() {
    setState(() {
      if (flagReversed == eGrup) {
        showDashboard.sort((a, b) =>
            b.groupDealer.toUpperCase().compareTo(a.groupDealer.toUpperCase()));
        flagReversed = '!$eGrup';
      } else {
        showDashboard.sort((a, b) =>
            a.groupDealer.toUpperCase().compareTo(b.groupDealer.toUpperCase()));
        flagReversed = eGrup;
      }
    });
  }
  ...
  Widget filterDrawer() {
    return Drawer(
      child: ListView(
        children: [
          ExpansionTile(
            title: Text('GROUP', style: text12SB),
          ...
          children: [
            Row(
              ...
              children: [
                ...
                Text('BY GROUP DEALER', style: text20SB),
                const Spacer(),
                ElevatedButton.icon(
                    onPressed: () {},
              ...
              child: Table(
                ...
                children: [
                  TableRow(
                    ...
                    children: [
                      HeaderTable(
                          eGrup, Alignment.center, flagReversed, sortGRUP),
                      HeaderTable(
                    ...
                    return TableRow(
                      ...
                      children: [
                        Tooltip(
                          ...
                          child: TextTable(
                              item.groupDealer, Alignment.centerLeft, 1),
                        ),
