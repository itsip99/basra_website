...
class Dashboard05 extends StatefulWidget {
  const Dashboard05(this.listDashboard, {super.key});
  final List<Dashboard> listDashboard;

  @override
  State<Dashboard05> createState() => _Dashboard05State();
}

class _Dashboard05State extends State<Dashboard05>
    with AutomaticKeepAliveClientMixin<Dashboard05> {
  ...
  void sortKota() {
    setState(() {
      if (flagReversed == eKota) {
        showDashboard.sort((a, b) =>
            b.cDistrict.toUpperCase().compareTo(a.cDistrict.toUpperCase()));
        flagReversed = '!$eKota';
      } else {
        showDashboard.sort((a, b) =>
            a.cDistrict.toUpperCase().compareTo(b.cDistrict.toUpperCase()));
        flagReversed = eKota;
      }
    });
  }
    ...
    return Drawer(
      child: ListView(
        children: [
          ...
          ExpansionTile(
            title: Text('KAB/KOTA', style: text12SB),
            childrenPadding: const EdgeInsets.symmetric(horizontal: 5),
            children: [
              GridView.count(
                crossAxisCount: 2,
          ...
          children: [
            Row(
              ...
              children: [
                ...
                Text('BY KAB/KOTA', style: text20SB),
                const Spacer(),
                ElevatedButton.icon(
                    onPressed: () {},
              ...
              child: Table(
                ...
                children: [
                  TableRow(
                    ...
                    children: [
                      HeaderTable(
                          eKota, Alignment.center, flagReversed, sortKota),
                      HeaderTable(
                    ...
                    return TableRow(
                      ...
                      children: [
                        Tooltip(
                          ...
                          child: TextTable(
                              item.cDistrict, Alignment.centerLeft, 1),
                        ),
